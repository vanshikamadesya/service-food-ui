...
const Timeline: React.FC<TimelineProps> = ({ items }) => {
  ...
  return (
    <div className="bg-[#EFEBE7] p-3 relative w-full mx-auto">
      ...
      <div className="relative flex items-center justify-between w-full">
        <div className="absolute top-[50%] left-0 w-full h-0.5 bg-gray-300 translate-y-3" />
      ...
      <div className="relative overflow-hidden mt-8">
        ...
        >
          {items.map((item, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row items-stretch p-6 max-w-5xl mx-auto">
                {/* Image Section */}
                ...
                <div className="w-full md:w-1/2 bg-white p-6 shadow-lg rounded-lg flex flex-col justify-center">
                  <h2 className="text-[#86704D] text-4xl font-bold">
                    {item.year}
                  </h2>

                  <p className="text-[#86704D] mt-4">{item.description}</p>
                </div>
              </div>
            </SwiperSlide>
          ))}
      ...
      <div className="flex justify-end gap-6 mt-6 right-6">
        <button
