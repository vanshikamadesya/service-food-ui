...
function MoreArticle() {
  ...
  return (
    <div className="h=[90vh] h-auto lg:h-screen w-full bg-[#EFEBE7] font-inter pb-20">
      {/* Heading - Maintaining original styling for large screens */}
      <div className="text-center pt-8 lg:pt-16 pb-6 lg:pb-12">
        <h2 className="text-[#505050] text-2xl lg:text-4xl font-bold uppercase tracking-wide font-inter">MORE ARTICLES</h2>
      ...
      <div className="relative w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-0 lg:pl-40 pt-6 lg:pt-20">
        <div className="relative">
            ...
            {articles.map((article) => (
              <SwiperSlide key={article.id} className="flex justify-center">
                <div className="w-full transition-all duration-300">
                  ...
                  <h3 className="text-xl lg:text-2xl font-semibold uppercase mb-2 lg:mb-3 font-inter">{article.title}</h3>
          ...
          <div className={`absolute top-0 right-0 w-1/5 lg:w-1/6 h-[calc(100%-120px)] lg:h-[calc(100%-100px)] bg-gradient-to-l from-[#EFEBE7] to-transparent z-10 pointer-events-none transition-opacity duration-300 ${
